...
const QString SettingsNames::guiPreferPlaintextRendering = QLatin1String("preferPlaintextRendering");
...
const QString SettingsNames::imapAutoExpunge = QLatin1String("imap.autoExpunge");
const QString SettingsNames::imapAutoLoadImages = QLatin1String("imap.autoLoadImages");
