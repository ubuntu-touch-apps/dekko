...
public:
    PasswordWatcher(QObject *parent, Plugins::PluginManager *manager);
...
public slots:
    void reloadPassword(const QString &accountName, const QString &accountType);
    void setPassword(const QString &accountName, const QString &accountType, const QString &password);
