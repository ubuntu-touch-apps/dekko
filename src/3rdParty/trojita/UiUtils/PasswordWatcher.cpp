...
PasswordWatcher::PasswordWatcher(QObject *parent, Plugins::PluginManager *manager) :
...
void PasswordWatcher::reloadPassword(const QString &accountName, const QString &accountType)
{
    m_didReadOk = false;
    m_password = QString();
...
void PasswordWatcher::setPassword(const QString &accountName, const QString &accountType, const QString &password)
{
    m_didWriteOk = false;
    ++m_pendingActions;
    m_accountName = accountName;
...
void PasswordWatcher::clearCurrentPassword()
{
    m_password = QString();
}
