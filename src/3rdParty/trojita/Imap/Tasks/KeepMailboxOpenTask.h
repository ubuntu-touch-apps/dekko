...
public:
    ...
    */
    ...
    void requestPreviewDownload(const uint uid, const QString &partId);
...
protected:
    ...
    */
    ...
    QMap<QString, QList<uint> > requestedPreviews;
