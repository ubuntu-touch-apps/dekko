...
public slots:
    ...
    CommandHandle authenticate(const QByteArray &saslMethod, const QString &accessToken);
...
signals:
    ...
    */
    ...
    void fileDownloadProgress(qint64 byteDownloaded, qint64 byteTotal);
...
private:
    ...
    int fileDownloadingTotalSize;
    QElapsedTimer fileDownloadProgressSignalChoke;
    const int fileDownloadProgressSignalInterval = 100;
};
