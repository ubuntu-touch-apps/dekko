...
#include "app/Notifications/MailboxWatcher.h"
...
class Model: public QAbstractItemModel
{
    ...
    Q_PROPERTY(QByteArray oauthAccessToken READ oauthAccessToken WRITE setOauthAccessToken)
    ...
    Q_PROPERTY(QStringList capabilities READ capabilities NOTIFY capabilitiesUpdated)
...
public:
    ...
    */
    Q_INVOKABLE void resyncMailbox(const QModelIndex &mbox);

    /** @short Mark all messages in a given mailbox as read */
    Q_INVOKABLE void markMailboxAsRead(const QModelIndex &mailbox);
    ...
    Q_INVOKABLE void expungeMailbox(const QModelIndex &mailbox);
    ...
    Q_INVOKABLE void deleteMailbox(const QString &name);
    ...
    */
    ...
    QByteArray oauthAccessToken() const;
    void setOauthAccessToken(const QByteArray &token);
    ...
    */
    ...
    TreeItemMailbox *getToplevelMailboxItem();
public slots:
...
signals:
    ...
    */
    ...
    void fileDownloadProgress(qint64 bytesDownloaded, qint64 bytesTotal);
private:
    ...
    friend class Dekko::Models::MessageListModel;
    friend class Dekko::Notifications::MailboxWatcher;
    ...
    friend class UnityNetworkWatcher;
    ...
    void askForPreview(TreeItemMessage *item, PreloadingMode preloadMode);
