...
public:
    ...
    */
    ...
    QString removeEmptyLine(QString string);
...
class TreeItemMessage: public TreeItem
{
    ...
    bool m_flagsHandled;
    bool m_wasUnread;
    FetchingState m_previewFetchState;
...
public:
    ...
    QString preview();
    void fetchPreview(Model *model);
    void setPreviewFetchStatus(FetchingState state);
    FetchingState previewFetchState() { return m_previewFetchState; }
    bool previewFetched() {return m_previewFetchState == DONE || m_previewFetchState == UNAVAILABLE;}
    bool previewLoading() {return m_previewFetchState == LOADING;}
...
public:
    ...
    virtual QString partIdForFetchPreview() const;
...
public:
    ...
    virtual TreeItem *specialColumnPtr(int row, int column) const;
    virtual void silentlyReleaseMemoryRecursive();
    void setBodyText(TreeItemPart * partText);
};
