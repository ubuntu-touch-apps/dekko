...
class MsgListModel: public QAbstractProxyModel
{
    ...
    Q_PROPERTY(QString mailboxName READ mailboxName NOTIFY mailboxChanged)
    Q_PROPERTY(int unreadCount READ unreadCount NOTIFY unreadCountPossiblyChanged)
...
public slots:
    ...
    void handleMessageCountPossiblyChanged(QModelIndex mailboxIndex);
...
signals:
    ...
    void unreadCountPossiblyChanged();
