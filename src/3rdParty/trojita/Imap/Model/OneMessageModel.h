...
class OneMessageModel: public QObject
{
    ...
    Q_PROPERTY(bool isMarkedFlagged READ isMarkedFlagged WRITE setMarkedFlagged NOTIFY flagsChanged)
    Q_PROPERTY(QUrl mainPartUrl READ mainPartUrl NOTIFY mainPartUrlChanged)
    Q_PROPERTY(QString mainPartMimeType READ mainPartMimeType NOTIFY mainPartUrlChanged)
    ...
    Q_PROPERTY(QModelIndex messageFirstChildIndex READ messageFirstChildIndex NOTIFY messageFirstChildIndexChanged)
...
public:
    explicit OneMessageModel(QObject *parent = 0);
    explicit OneMessageModel(QObject *parent, Model *model);
    ...
    void setMarkedFlagged(const bool marked);
    QUrl mainPartUrl() const;
    QString mainPartMimeType() const;
    QModelIndex mainPartIndex() const;
...
signals:
    ...
    void messageFirstChildIndexChanged();
