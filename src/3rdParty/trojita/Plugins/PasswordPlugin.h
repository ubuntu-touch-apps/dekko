...
signals:
    ...
    void passwordAvailable(const QString &accountId, const QString &accountType, const QString &password);

    /** @short Emitted when job finish storing password */
    void passwordStored(const QString &accountId);

    /** @short Emitted when job finish deleting password */
    void passwordDeleted(const QString &accountId);
